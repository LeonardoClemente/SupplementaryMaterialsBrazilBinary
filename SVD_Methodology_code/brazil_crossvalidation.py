...
# Files and folders
heatmap_path = '/Users/leonardo/Desktop/FORECASTING/STOLERMAN/BRAZIL_crossvalidation/heatmap_dicts'
...
for station in brazil_stations:
    ...
    for y in range(ystart,yend):
        ...
        time.sleep(3)
        heatmap = SVDC_cross_validation(full_df,first_year_insample = first_year_insample,
                          last_year_insample = last_year_insample,\
                           period_of_interest=['{0}-01-01'.format(last_year_insample), '{0}-05-31'.format(last_year_insample)],\
                           prediction_year=y, epidemic_classification_dict=epidemic_classification_dict, training_year_window='ALL',\
